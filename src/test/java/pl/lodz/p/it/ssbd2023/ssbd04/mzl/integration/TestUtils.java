...
public class TestUtils {
    ...
    static void init() {
        ...
        baseUri = "https://localhost:8443/ssbd-group4-project/api/account";
        teamUri = "https://localhost:8443/ssbd-group4-project/api/team";
        leagueUri = "https://localhost:8443/ssbd-group4-project/api/league";
        gameUri = "https://localhost:8443/ssbd-group4-project/api/game";
        playerUri = "https://localhost:8443/ssbd-group4-project/api/player";
        scoreboardUri = "https://localhost:8443/ssbd-group4-project/api/scoreboard";
        timetableUri = "https://localhost:8443/ssbd-group4-project/api/timetable";
...
//            createReferee();
    ...
    public static String createTeam() {
        String url = "jdbc:mysql://localhost:3306/siatka?useSSL=false&allowPublicKeyRetrieval=true&allowPublicKeyRetrieval=true";
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO teams (id, city, is_approved, team_name, version, captain_id, coach_id, league_id) VALUES (UUID_TO_BIN(?), 'Warszawa', true, ?, 0, null, null, null);";
    ...
    public static String createTeamWithLeagueId(String leagueId) {
        String url = "jdbc:mysql://localhost:3306/siatka?useSSL=false&allowPublicKeyRetrieval=true";
        String accountname = "siatka_admin";
        String password = "siatka_admin";
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO teams (id, city, is_approved, team_name, version, captain_id, coach_id, league_id) VALUES (UUID_TO_BIN(?), 'Warszawa', true, ?, 0, null, null, UUID_TO_BIN(?));";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
            preparedStatement.setString(1, uuid);
            preparedStatement.setString(2, randomLogin());
    ...
    public static void createAdmin(){
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO accounts "
                    + "(id, version, email, is_active, is_approved, is_blocked, lastname, locale, login, login_timestamp, name, password) "
                    + "VALUES (UUID_TO_BIN(?), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);

            preparedStatement.setString(1, "d93b7ab9-da9b-490c-a096-5c48437cd3a8");
            preparedStatement.setInt(2, 0);
            preparedStatement.setString(3, "TESTadminMZL@mail.com");
            preparedStatement.setBoolean(4, true);
            preparedStatement.setBoolean(5, true);
            preparedStatement.setBoolean(6, false);
            preparedStatement.setString(7, "TESTadminMZL");
            preparedStatement.setString(8, "en");
            preparedStatement.setString(9, "TESTadminMZL");
            preparedStatement.setTimestamp(10, Timestamp.valueOf("2023-05-18 18:53:32.000000"));
            preparedStatement.setString(11, "TESTadminMZL");
            preparedStatement.setString(12, "$2a$12$t8yl1BfGAqp4ISTUByW/UuYk0/KPMvINjZAvxNbet1QKWyCPbQB4G");

// Wykonanie zapytania
            preparedStatement.executeUpdate();

            String query1 = "INSERT INTO roles (id, version, role_type, account_id) VALUES (UUID_TO_BIN(?), ?, ?, UUID_TO_BIN(?))";
            PreparedStatement preparedStatement12 = connection.prepareStatement(query1);
            preparedStatement.setString(1, "4570ecea-3f89-41e3-9574-f4890b2e593f");
            preparedStatement.setInt(2, 0);
            preparedStatement.setString(3, "ADMIN");
            preparedStatement.setString(4, "d93b7ab9-da9b-490c-a096-5c48437cd3a8");
            preparedStatement12.executeUpdate();

            String query2 = "INSERT INTO admins (id) VALUES (UUID_TO_BIN(?))";
            PreparedStatement preparedStatement2 = connection.prepareStatement(query2);
            preparedStatement2.setString(1, "4570ecea-3f89-41e3-9574-f4890b2e593f");
    ...
    public static void createManager(){
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO accounts (id, version, email, is_active, is_approved, is_blocked, lastname, locale, login, login_timestamp, name, password) VALUES (UUID_TO_BIN('9d4245e4-d90e-43f2-a9b3-9b5c5e68f8a7'), 0, 'TESTmanagerMZL@mail.com', true, true, false, 'TESTmanagerMZL', 'en', 'TESTmanagerMZL', '2023-05-18 18:53:32.000000', 'TESTmanagerMZL', '$2a$12$t8yl1BfGAqp4ISTUByW/UuYk0/KPMvINjZAvxNbet1QKWyCPbQB4G');\n" +
                    "INSERT INTO roles (id, version, role_type, account_id) VALUES (UUID_TO_BIN('29811b1e-5021-4a3e-9568-c6d76c80764f'), 0, 'MANAGER', UUID_TO_BIN('9d4245e4-d90e-43f2-a9b3-9b5c5e68f8a7'));\n" +
    ...
    public static String createGame(String refereeId, String gamesquadAId, String gamesquadBId) {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO games(id,version,queue,start_time,referee_id,score_id,teamagamesquad,teambgamesquad, venue_id, is_postponed, is_postpone_request)VALUES(UUID_TO_BIN(?),0,1,'2023-06-09T14:40:48+00:00',UUID_TO_BIN(?),UUID_TO_BIN(?),UUID_TO_BIN(?), UUID_TO_BIN(?),UUID_TO_BIN(?), false, false);";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
            preparedStatement.setString(1, uuid);
    ...
    private static String createScore() {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO scores(id,version,approvalteama, approvalteamb, scoreboard_points_a, scoreboard_points_b )VALUES(UUID_TO_BIN(?),0, ?, ?, 0, 0);";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
            preparedStatement.setString(1, uuid);
    ...
    public static String createTimetable() {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO timetables(id,version,start_date, end_date)VALUES(UUID_TO_BIN(?),0,'2023-06-09T14:40:48+00:00','2023-06-10T14:40:48+00:00');";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
            preparedStatement.setString(1, uuid);
    ...
    public static String createGamesquad(String teamId) {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO game_squads(id,version,team_id)VALUES(UUID_TO_BIN(?),0,UUID_TO_BIN(?));";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
            preparedStatement.setString(1, uuid);
    ...
    public static GameDTO createMzl10Game(String refereeId, String gameSquadA, String gameSquadB) {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO games (id, end_time, is_postponed, is_postpone_request, queue, start_time, version, referee_id, score_id, teamagamesquad, teambgamesquad, venue_id, round_id) VALUES (UUID_TO_BIN(?), null , false, false,  1, '2023-07-01 14:30:00', CAST(? AS BIGINT), UUID_TO_BIN(?), UUID_TO_BIN(?), UUID_TO_BIN(?), UUID_TO_BIN(?), UUID_TO_BIN(?), UUID_TO_BIN(?))";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
            preparedStatement.setString(1, uuid);
    ...
    public static String createVenue() {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO venues(id,version,court_number,address)VALUES(UUID_TO_BIN(?),0,(?),'piotrkowska');";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
    ...
    public static List<String> createPlayer(int number, String teamid) {
        ...
        for (int i = 0; i < number; i++) {
            ...
            try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
                String sqlQuery = "INSERT INTO players(id,version,last_name,first_name,is_pro,age,team_id)VALUES(UUID_TO_BIN(?),0,'testowy','tester',false,24,UUID_TO_BIN(?));";
                PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
                preparedStatement.setString(1, uuid);
                preparedStatement.setString(2, teamid);
                preparedStatement.executeUpdate();
    ...
    public static CreatePlayerDTO createAddPlayerToTeamdDTO() {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            ...
            String sqlQuery2 = "INSERT INTO teams (id, city, is_approved, team_name, version, captain_id, coach_id, league_id) VALUES ('223e4567-e89b-12d3-a456-426655440010', 'City 1', true, 'Team 2', 1, NULL, NULL, NULL);\n";
    ...
    public static String createReferee() {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery1 = "INSERT INTO accounts (id, version, email, is_active, is_approved, is_blocked, lastname, locale, login, login_timestamp, name, password) VALUES (UUID_TO_BIN(?), 0, ?, true, true, false, 'referee', 'en', ?, '2023-05-18 18:53:32.000000', 'referee', '$2a$12$t8yl1BfGAqp4ISTUByW/UuYk0/KPMvINjZAvxNbet1QKWyCPbQB4G');\n";
            String sqlQuery2 = "INSERT INTO roles (id, version, role_type, account_id) VALUES (UUID_TO_BIN(?), 0, 'REFEREE', UUID_TO_BIN(?));\n";
            String sqlQuery3 = "INSERT INTO referees (id) VALUES (UUID_TO_BIN(?));\n";
    ...
    public static String createGame(String refereeId, String gamesquadAId, String gamesquadBId, String roundId, String scoreId) {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO games (id, end_time, is_postponed, is_postpone_request, queue, start_time, version, referee_id, score_id, teamAGameSquad, teamBGameSquad, venue_id, round_id) VALUES (UUID_TO_BIN(?), '2023-06-01 15:00:00', 'false', 'false',  1, '2023-06-01 14:30:00', 1, UUID_TO_BIN(?), UUID_TO_BIN(?), UUID_TO_BIN(?), UUID_TO_BIN(?), UUID_TO_BIN(?), UUID_TO_BIN(?));";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
            preparedStatement.setString(1, uuid);
            preparedStatement.setString(2, refereeId);
            preparedStatement.setString(3, scoreId);
    ...
    public static String createLeague() {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO leagues (id, version, league_number, season) VALUES (UUID_TO_BIN(?), 0, 1, '2022/2023');";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
            preparedStatement.setObject(1, uuid);
            preparedStatement.executeUpdate();
            return uuid;
    ...
    public static CreateLeagueWithRoundParams createLeagueWithRound() {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery1 = "INSERT INTO leagues (id, version, league_number, season) VALUES (UUID_TO_BIN(?), 0, 1, '2022/2023');";
            String sqlQuery2 = "INSERT INTO scoreboards (id, version) VALUES (UUID_TO_BIN(?), 1);";
            String sqlQuery3 = "INSERT INTO rounds (id, version, scoreboard_id, timetable_id, round_number) VALUES (UUID_TO_BIN(?), 1, UUID_TO_BIN(?), UUID_TO_BIN(?), 1);";
            String sqlQuery4 = "INSERT INTO leagues_rounds (round_id, league_id) VALUES (UUID_TO_BIN(?), UUID_TO_BIN(?));";
            PreparedStatement preparedStatement1 = connection.prepareStatement(sqlQuery1);
    ...
    public static String createUnapprovedTeam() {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO teams (id, city, is_approved, team_name, version, captain_id, coach_id, league_id) VALUES (UUID_TO_BIN(?), 'Warszawa', false, ?, 0, null, null, null);";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
            preparedStatement.setString(1, uuid);
            preparedStatement.setString(2, teamName);
            preparedStatement.executeUpdate();
    ...
    public static String createCaptain(String email, String login) {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery1 = "INSERT INTO accounts (id, version, email, is_active, is_approved, is_blocked, lastname, locale, login, login_timestamp, name, password) VALUES (UUID_TO_BIN(?), 0, ?, true, true, false, 'captain', 'en', ?, '2023-05-18 18:53:32.000000', 'captain', '$2a$12$t8yl1BfGAqp4ISTUByW/UuYk0/KPMvINjZAvxNbet1QKWyCPbQB4G')";
            ...
            String sqlQuery2 = "INSERT INTO roles (id, version, role_type, account_id) VALUES (UUID_TO_BIN(?), 0, 'CAPTAIN', UUID_TO_BIN(?))";
            PreparedStatement preparedStatement2 = connection.prepareStatement(sqlQuery2);
            preparedStatement2.setString(1, roleId);
            preparedStatement2.setString(2, accountId);
            preparedStatement2.executeUpdate();

            String sqlQuery3 = "INSERT INTO captains (id) VALUES (UUID_TO_BIN(?))";
            PreparedStatement preparedStatement3 = connection.prepareStatement(sqlQuery3);
    ...
    public static String createMzl6Team(String captainId) {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO teams (id, city, is_approved, team_name, version, captain_id, coach_id, league_id) VALUES (UUID_TO_BIN(?), 'Warszawa', true, ?, 0, UUID_TO_BIN(?), null, null);";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
            preparedStatement.setString(1, uuid);
            preparedStatement.setString(2, teamName);
    ...
    public static TeamDTO createMzl10TeamWithCaptain(String captainId) {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO teams (id, city, is_approved, team_name, version, captain_id, coach_id, league_id) VALUES (UUID_TO_BIN(?), 'Warszawa', true, ?, CAST(? AS BIGINT), UUID_TO_BIN(?), null, null);";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
            preparedStatement.setString(1, uuid);
            preparedStatement.setString(2, teamName);
    ...
    public static String createMzl6TeamWithCoach(String coach) {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO teams (id, city, is_approved, team_name, version, captain_id, coach_id, league_id) VALUES (UUID_TO_BIN(?), 'Warszawa', true, ?, 0, null, UUID_TO_BIN(?), null);";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
            preparedStatement.setString(1, uuid);
            preparedStatement.setString(2, teamName);
    ...
    public static String createMzl6Game(String refereeId, String gameSquadA, String gameSquadB) {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO games (id, end_time, is_postponed, is_postpone_request, queue, start_time, version, referee_id, score_id, teamagamesquad, teambgamesquad, venue_id) VALUES (UUID_TO_BIN(?), null , false, false,  1, '2023-07-01 14:30:00', 0, UUID_TO_BIN(?), null, UUID_TO_BIN(?), UUID_TO_BIN(?), UUID_TO_BIN(?))";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
            preparedStatement.setString(1, uuid);
            preparedStatement.setString(2, refereeId);
    ...
    public static String createMzl6EndedGame(String refereeId, String gameSquadA, String gameSquadB) {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO games (id, end_time, is_postponed, is_postpone_request, queue, start_time, version, referee_id, score_id, teamagamesquad, teambgamesquad, venue_id) VALUES (UUID_TO_BIN(?), '2023-07-07 14:30:00' , false, false,  1, '2023-07-01 14:30:00', 0, UUID_TO_BIN(?), null, UUID_TO_BIN(?), UUID_TO_BIN(?), UUID_TO_BIN(?))";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
            preparedStatement.setString(1, uuid);
            preparedStatement.setString(2, refereeId);
            preparedStatement.setString(3, gameSquadA);
    ...
    public static String createUnapprovedTeamWithManager(String managerId, String accountId) {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO teams (id, city, is_approved, team_name, version, captain_id, coach_id, league_id) VALUES (UUID_TO_BIN(?), 'Warszawa', false, ?, 0, null, null, null);\n";
            String sqlQuery2 = "UPDATE managers SET team_id = UUID_TO_BIN(?) WHERE id = UUID_TO_BIN(?);";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
            PreparedStatement preparedStatement2 = connection.prepareStatement(sqlQuery2);
            preparedStatement.setString(1, uuid);
            preparedStatement.setString(2, randomLogin());
    ...
    public void addManagerToTeam(String managerId, String teamId) {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "UPDATE managers SET team_id = UUID_TO_BIN(?) WHERE id = UUID_TO_BIN(?)";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
    ...
    public static String createPastGame(String refereeId) {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO games (id, version, end_time, queue, start_time, referee_id, venue_id) VALUES (UUID_TO_BIN(?), '2023-05-05 14:40:48', 0, 1, '2023-05-05 14:00:48', UUID_TO_BIN(?), UUID_TO_BIN(?));";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
            preparedStatement.setString(1, uuid);
            preparedStatement.setString(2, refereeId);
    ...
    public static String createFutureNotEndedGame(String refereeId) {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO games (id, version, end_time, queue, start_time, referee_id, venue_id) VALUES (UUID_TO_BIN(?), '2023-08-08 14:40:48', 0, 1, '2023-08-08 14:00:48', UUID_TO_BIN(?), UUID_TO_BIN(?));";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
            preparedStatement.setString(1, uuid);
            preparedStatement.setString(2, refereeId);
            preparedStatement.setString(3, createVenue());
    ...
    public static String createAcceptedScore(String gameId, int pointsA, int pointsB) {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO scores (id, scoreboard_points_a, scoreboard_points_b, version, approvalteama, approvalteamb) VALUES (UUID_TO_BIN(?), (?), (?), 1, 'APPROVED', 'APPROVED');";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
            preparedStatement.setString(1, uuid);
    ...
    public static String createUnacceptedScore(int pointsA, int pointsB) {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO scores (id, scoreboard_points_a, scoreboard_points_b, version, approvalTeamA, approvalTeamB) VALUES (UUID_TO_BIN(?), (?), (?), 1, 'NONE', 'APPROVED');";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
            preparedStatement.setString(1, uuid);
    ...
    public static String createSet(String scoreId, int pointsA, int pointsB) {
        ...
        try (Connection connection = DriverManager.getConnection(url, accountname, password)) {
            String sqlQuery = "INSERT INTO sets (id, team_a_points, team_b_points, version, score_id) VALUES (UUID_TO_BIN(?), (?), (?), 1, UUID_TO_BIN(?));";
            PreparedStatement preparedStatement = connection.prepareStatement(sqlQuery);
            preparedStatement.setString(1, uuid);
            preparedStatement.setInt(2, pointsA);
            preparedStatement.setInt(3, pointsB);
